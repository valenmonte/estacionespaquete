...
This outlines how to propose a change to estacionespaquete. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("valenmonte/estacionespaquete", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://valenmonte.github.io/estacionespaquete/CODE_OF_CONDUCT.md).
